...
function validateStatus(status) {
  ...
  // Aliases
  const aliases = {
    'evaluada': 'Evaluated', 'enviada': 'Applied', 'aplicado': 'Applied', 'aplicada': 'Applied', 'sent': 'Applied',
    'cerrada': 'Discarded', 'descartado': 'Discarded', 'descartada': 'Discarded', 'cancelada': 'Discarded',
