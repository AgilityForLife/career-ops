...
<!-- Processed 2026-09-03 (Wednesday scan, covering since last run 2026-08-11). 6 new active postings evaluated; ~43 candidates logged to scan-history (location/domain/clearance/aggregator/backlog filters). WebFetch blocked for all job board domains — evaluations based on WebSearch JD summaries only. -->
https://job-boards.greenhouse.io/anthropic/jobs/5208193008  Anthropic | TPM, Launches (3.6/5) [SECONDARY] - PREPARE ONLY; best Anthropic fit of batch; CS-3 release governance→launch reliability bridge; $365-435K; NYC 25% hybrid
https://job-boards.greenhouse.io/3cloud/jobs/8747438002  3Cloud | Manager, Technology Transformation Advisory (3.7/5) [SECONDARY] - APPLY w/ caveats; 5+ CS engaged; consulting-vs-delivery gap; virtual-first remote; EXPIRES Sep 14; existing 3Cloud relationship
https://job-boards.greenhouse.io/anthropic/jobs/5256303008  Anthropic | TPM, API Platform (3.5/5) [SECONDARY] - PREPARE ONLY; cloud delivery bridge real; API platform domain gap; NYC 25% hybrid; ~$290-435K
https://job-boards.greenhouse.io/anthropic/jobs/5251612008  Anthropic | TPM, Databases (3.5/5) [SECONDARY] - PREPARE ONLY; Snowflake+multi-cloud is strongest hook; database infra depth gap; SF/NYC; ~$290-435K
https://job-boards.greenhouse.io/anthropic/jobs/5251609008  Anthropic | TPM, Apps Platform (3.3/5) [SECONDARY] - PREPARE ONLY; platform engineering domain further from background; NYC 25% hybrid; ~$290-435K
https://job-boards.greenhouse.io/flywheeldigital/jobs/5195229008  Flywheel Digital | TPM Contract (3.0/5) [SECONDARY] - PREPARE ONLY low priority; Jersey City 3-6mo contract; media/marketing domain mismatch; check C2C rate
