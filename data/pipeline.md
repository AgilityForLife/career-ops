...
<!-- Processed 2026-08-12 (Tuesday scan, covering since last run 2026-08-11). 5 new active postings evaluated; ~15 candidates logged to scan-history (location/aggregator/backlog/domain filters). WebFetch blocked for all job board domains — evaluations based on WebSearch JD summaries only. Greenhouse API also blocked (egress proxy). -->
https://job-boards.greenhouse.io/coretelligent/jobs/5177575008  Coretelligent | Senior Technical Project Manager (3.5/5) [SECONDARY] - APPLY w/ caveats; 4 CS engaged (CS-1/2/5/7); cloud infrastructure + regulated verticals (finserv/life sciences); MSP/client-facing gap; remote US; verify comp
https://boards.greenhouse.io/toast/jobs/7735834  Toast | Senior TPM (3.4/5) [SECONDARY] - PREPARE ONLY; CS-1/CS-5 engaged; delivery lifecycle ownership transfers but restaurant tech domain + external-partner model unfamiliar; remote US; comp ~$149-219K; verify posting still active (May 2026)
https://job-boards.greenhouse.io/flywheeldigital/jobs/5195229008  Flywheel Digital | TPM Contract (2.8/5) - REJECTED (short 3-6mo contract + 1 CS partially engaged + digital commerce domain wall + agency model)
https://jobs.lever.co/thinkahead/89607f7c-be9d-473f-ad0b-ec24ea6f4473  AHEAD | TPM (2.9/5) - REJECTED (hardware integration/supply chain domain wall; server/storage/networking ≠ software platform delivery)
https://job-boards.greenhouse.io/trace3/jobs/8092844  Trace3 | Sr. PM Remote (2.7/5) - REJECTED (hard 10+yr VAR/consulting org requirement; comp $120-135K at floor; 1 CS partial)
