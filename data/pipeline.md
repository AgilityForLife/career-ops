...
<!-- Processed 2026-08-28 (Thursday scan, covering since last run 2026-08-11). 5 new active postings evaluated; ~26 candidates logged to scan-history (location/domain/backlog/overleveled/aggregator filters). WebFetch blocked for all job board domains — evaluations based on WebSearch JD summaries only. Greenhouse API also blocked. -->
https://job-boards.greenhouse.io/navapbc/jobs/4258144009  Nava PBC | 1099 Project Manager / Scrum Master (4.3/5) [PRIMARY] - APPLY; 1099 structure (preferred!) + government cloud + SAFe + remote US $157.5-177.3K; 5+ CS engaged; verify security clearance req
https://job-boards.greenhouse.io/gitlab/jobs/8742113002  GitLab | Senior PM Enterprise Tech & AI (3.5/5) [SECONDARY] - APPLY w/ caveats; all-remote CS-1+CS-5; enterprise IT/apps not core cloud platform lane; verify comp meets target
https://job-boards.greenhouse.io/flywheeldigital/jobs/5195229008  Flywheel Digital | TPM Contract (3.3/5) [SECONDARY] - APPLY w/ caveats; contract NJ + UAT/hypercare/RACI match from Sanofi; media/marketing tech domain gap; verify C2C + rate
https://jobs.ashbyhq.com/coder/c726c69e-f0cd-45c3-b962-fb74cb207c0e  Coder | Technical Project Manager (3.2/5) [SECONDARY] - PREPARE ONLY; CS-1+CS-5 engaged; dev tools domain unfamiliar; verify requirements + comp
https://job-boards.greenhouse.io/jencapinc/jobs/4365961007  Jencap | Senior PM PMO (2.8/5) - REJECTED (insurance domain knowledge required = hard gate; no industry experience)
