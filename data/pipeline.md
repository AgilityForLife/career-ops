...
<!-- Processed 2026-08-14 (Thursday scan, covering since last run 2026-08-11). 6 new postings evaluated; ~19 candidates logged to scan-history (location/domain/aggregator/clearance/title filters). WebFetch blocked for all job board domains — evaluations based on WebSearch JD summaries only. -->
https://jobs.lever.co/nava/6f5acea0-0a70-4bd3-9962-ca7470907b8c  Nava | Sr. Project Manager (3.5/5) [SECONDARY] - APPLY w/ caveats; NJ hybrid 2-3 days; 9 scrum teams agile delivery; CS-1/CS-5/CS-6 engaged; consulting/client-facing PM gap; verify comp (not listed, mkt ~$131K NJ)
https://job-boards.greenhouse.io/nttdatausa/jobs/8318944002  NTT DATA | Scrum Master / Agile Coach (3.0/5) [PRIMARY] - APPLY w/ caveats; NYC onsite; SPC6 premium differentiator; de-emphasis cap applies (primarily coaching role); verify comp
https://jobs.ashbyhq.com/spear-ai/2ce2697f-499e-4406-9fbf-647f059723e4  Spear AI | Program Manager Gov AI (3.2/5) [SECONDARY] - PREPARE ONLY; multi-vendor gov AI program; CS-1/CS-5/CS-6 engaged; verify clearance requirements + comp; maritime/defense domain new
https://jobs.lever.co/ttecdigital/acfd565c-7367-45aa-8683-f6a5f62d7e4a  TTEC Digital | Principal TPM Google CCAI (2.8/5) - REJECTED (hard requirement: 2+ yrs Google CCAI/Conversational AI; NJ-eligible remote $140-165K but domain-specific barrier)
https://job-boards.greenhouse.io/nice/jobs/4934012101  NICE | Senior AI PM CX (2.9/5) - REJECTED (low CS engagement; AI/CX domain gap; customer-facing SW delivery outside internal-enterprise lane)
https://job-boards.greenhouse.io/charlesriverassociates/jobs/7983867  CRA | PM/Agile Master AI (2.7/5) - REJECTED (product/agile hybrid, not delivery PM; low CS engagement; explicitly "not a pure PM role")
