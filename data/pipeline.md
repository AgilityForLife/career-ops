...
<!-- Processed 2026-08-17 (Sunday scan, covering since last run 2026-08-11). 5 new active postings evaluated; ~38 candidates logged to scan-history (location/domain/backlog/aggregator filters). WebFetch blocked for all job board domains — evaluations based on WebSearch JD summaries only. -->
https://jobs.lever.co/nava/6f5acea0-0a70-4bd3-9962-ca7470907b8c  Nava | Sr. Project Manager / Contract Lead (3.8/5) [PRIMARY] - APPLY; NJ hybrid bullseye location; CS-1/5/6/7 strong; Agile+traditional PM dual expertise match; consulting client-facing gap; verify comp
https://boards.greenhouse.io/toast/jobs/8054004  Toast | Principal TPM, Toast IQ (3.7/5) [SECONDARY] - APPLY w/ caveats; remote US; CS-1/3/4/5 release governance bullseye; AI-native domain + Principal bar; exceptional comp potential
https://boards.greenhouse.io/toast/jobs/7735834  Toast | Senior TPM (3.6/5) [SECONDARY] - APPLY w/ caveats; remote US; CS-1/3/5 engaged; restaurant tech domain gap; verify comp
https://job-boards.greenhouse.io/anthropic/jobs/5208193008  Anthropic | TPM, Launches (3.5/5) [SECONDARY] - PREPARE ONLY; best Anthropic fit (launch orchestration vs infra/ML); NYC 25% feasible; comp $290-435K; AI domain gap; HELD for manual review
https://job-boards.greenhouse.io/anthropic/jobs/4989788008  Anthropic | TPM, Security (3.5/5) [SECONDARY] - PREPARE ONLY; CS-3/CS-7 governance bridge real; security domain tenure absent; comp $290-435K; HELD for manual review
