...
<!-- Processed 2026-08-20 (Wednesday scan, covering since last run 2026-08-11). 5 new active postings evaluated; ~40 candidates logged to scan-history (location/domain/aggregator/backlog filters). WebFetch blocked for all job board domains — evaluations based on WebSearch JD summaries only. 10 new Anthropic TPM postings + 9 new OpenAI TPM postings logged; most skipped on location (SF/Seattle) or domain (silicon/hardware/ML research). -->
https://job-boards.greenhouse.io/navapbc/jobs/4258144009  Nava PBC | 1099 PM / Scrum Master (3.9/5) [PRIMARY] - APPLY; 1099 contractor (preferred type); government digital services (VA/CMS/CDC); SAFe + regulated delivery; remote US; ~$154K estimated
https://job-boards.greenhouse.io/octaura/jobs/5102129007  Octaura | Scrum Master / Project Manager (3.6/5) [PRIMARY] - APPLY; fintech SM/PM hybrid; SSM/SPC6 exceed CSM/PSM bar; NYC $130-160K + equity + bonus; verify hybrid policy
https://job-boards.greenhouse.io/agilesixv2/jobs/6263084003  Agile Six | Delivery Manager - Networking (3.5/5) [PRIMARY] - APPLY w/ caveats; remote US gov (VA/CMS/CDC); SDVOSB; anticipated role; verify comp + timeline
https://job-boards.greenhouse.io/icapitalnetwork/jobs/8566346002  iCapital | PM and Process Analyst VP (3.4/5) [SECONDARY] - PREPARE ONLY; NYC fintech ~$177K; consulting + ML + process analyst triple gate
https://job-boards.greenhouse.io/abnormalsecurity/jobs/7754192003  Abnormal Security | Transformation Strategy Manager (3.1/5) [SECONDARY] - PREPARE ONLY low priority; remote US AI transformation; hands-on AI fluency hard req
