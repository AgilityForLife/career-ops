...
<!-- Processed 2026-08-18 (Monday scan, covering since last run 2026-08-11). 4 new active postings evaluated; ~21 candidates logged to scan-history (domain/location/comp/specialized filters). WebFetch + Greenhouse API blocked — evaluations based on WebSearch JD summaries only. -->
https://job-boards.greenhouse.io/navapbc/jobs/4258144009  Nava PBC | 1099 PM/Scrum Master (4.0/5) [PRIMARY] - APPLY w/ verification; strongest find — 5 CS engaged, 1099 preferred contract type, $157.5-177.3K (~$76-85/hr); cloud infrastructure + SAFe + gov delivery; VERIFY NJ eligibility before applying
https://boards.greenhouse.io/toast/jobs/7851279  Toast | IT Delivery Manager (3.2/5) [SECONDARY] - APPLY w/ caveats; decent general PM delivery fit but lacks cloud/data/regulated differentiators; remote US $111-178K
https://job-boards.greenhouse.io/jencapinc/jobs/4365961007  Jencap | Senior PM PMO (3.0/5) [SECONDARY] - PREPARE ONLY; NJ/NY or remote, $110-175K, insurance regulated industry; traditional PMO under-utilizes technical differentiators
https://job-boards.greenhouse.io/anthropic/jobs/5368023008  Anthropic | TPM GTM Systems (2.8/5) [SECONDARY] - PREPARE ONLY, low priority; exceptional comp ~$290K+ but GTM/CPQ/lead-to-cash domain is material gap; NYC 25% hybrid
